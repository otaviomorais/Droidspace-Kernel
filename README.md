...
Custom kernel for **POCO F3 (alioth)** based on [MagicTime Kernel](https://github.com/TIMISONG-dev/kernel_xiaomi_sm8250) with full [DroidSpaces](https://github.com/ravindu644/Droidspaces-OSS).
